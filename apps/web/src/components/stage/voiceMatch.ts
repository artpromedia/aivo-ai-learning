// Compare a Whisper / Web-Speech transcript against an expected answer.
//
// STT output is noisy: punctuation, casing, articles, numbers vs. number-words,
// trailing "uh"s, accent diacritics. We normalize both sides and check for
// equality or containment. Multiple acceptable answers can be separated by "|".
