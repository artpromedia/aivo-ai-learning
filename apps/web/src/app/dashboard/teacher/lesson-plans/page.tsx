  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="bg-white rounded-2xl p-12 text-center border border-slate-100 shadow-sm">
        ...
        <h2 className="text-xl font-heading font-bold text-slate-900 mb-2">Lesson Plan Generator</h2>
        <p className="text-sm text-slate-500 max-w-md mx-auto mb-6">
          AI-powered lesson plan generation based on your learners&apos; Brain Clone profiles, functioning levels, and IEP goals. Coming soon.
        </p>
