...
import { generateDemoBeats } from "./demoBeats";
...
export default function LessonPage() {
  ...
  const tDemoBeats = useTranslations("demoBeats");
  ...
  const startStage = async () => {
    ...
    const beats = generateDemoBeats(tutorKey, name, functioningLevel, tDemoBeats);
