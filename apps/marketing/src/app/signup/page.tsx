...
export default function SignupRedirectPage() {
  ...
  useEffect(() => {
    if (webAppUrl) {
      window.location.href = `${webAppUrl}/signup`;
    }
  }, [webAppUrl]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 to-white flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <p className="text-slate-500 font-body mb-8">
          Join thousands of families using AIVO Learning to give their children a personalized, adaptive learning experience.
        </p>
        <div className="space-y-3">
          <Link
            href={webAppUrl ? `${webAppUrl}/signup` : "/"}
        ...
        <p className="text-sm text-slate-400 font-body mt-6">
          ...
          <Link href="/login" className="text-violet-600 font-semibold hover:text-violet-800 transition">
            Sign In
          </Link>
        </p>
      </div>
