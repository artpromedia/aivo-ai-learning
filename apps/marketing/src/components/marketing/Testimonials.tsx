...
const TESTIMONIALS = [
  { quoteKey: "t1_quote", nameKey: "t1_name", roleKey: "t1_role", initials: "P3", color: "border-purple-200 bg-purple-50/50", ring: "ring-purple-200 text-purple-700 bg-purple-100" },
  { quoteKey: "t2_quote", nameKey: "t2_name", roleKey: "t2_role", initials: "SE", color: "border-cyan-200 bg-cyan-50/50", ring: "ring-cyan-200 text-cyan-700 bg-cyan-100" },
  { quoteKey: "t3_quote", nameKey: "t3_name", roleKey: "t3_role", initials: "DA", color: "border-amber-200 bg-amber-50/50", ring: "ring-amber-200 text-amber-700 bg-amber-100" },
  { quoteKey: "t4_quote", nameKey: "t4_name", roleKey: "t4_role", initials: "L4", color: "border-emerald-200 bg-emerald-50/50", ring: "ring-emerald-200 text-emerald-700 bg-emerald-100" },
] as const;
