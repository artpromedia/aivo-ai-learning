...
This is especially important here: AIVO builds learning tools used by
children and learners with special needs. We hold ourselves to a higher
bar in everything we ship and everything we say while building it.
...
- Focusing on what is best, not just for us as individuals, but for the
  overall community and for the learners we serve
...
- Content that demeans or marginalises children, learners with
  disabilities, or any other group
...
requests, discussions, code comments, project Slack/chat, in-person and
virtual events) and also applies when an individual is officially
representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported to the project team at **`conduct@aivolearning.com`**.
